...
if DB_ENGINE == 'mysql':
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='labitory'),
...
LAB_BOOKING_ADVANCE_DAYS = int(os.environ.get('LAB_BOOKING_ADVANCE_DAYS', '30'))
